...
namespace API_auto.mappers
{
    public static class IdMock
    {
        public static DocumentId GetSeller([FromForm] IncomingData file)
        {
            ...
            seller.fullName = new FullName("Tarsitu Mario",ClientType.Seller,0.98f);
            ...
            seller.email = new Email("-",ClientType.Seller,0.98f);
        ...
        public static DocumentId GetBuyer([FromForm] IncomingData file)
        {
            ...
            buyer.email = new Email( "-",ClientType.Buyer,0.98f);
        ...
        public static AutoId GetAuto([FromForm] IncomingData file)
        {
            ...
            auto.autoCardId = new AutoCardId("11111",0.98f);
            auto.price = new Price(PriceHelper.ConversieNumarDouble(file.Price),0.98f);
