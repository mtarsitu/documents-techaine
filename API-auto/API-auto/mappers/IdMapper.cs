...
namespace API_auto.mappers
{
    public static class IdMapper
    {
        public static DocumentId GetClientData(AnalyzeResult result, ClientType clientType, string phone, string email)
        {
            ...
            client.email = new Email(email != null ? email : "-", clientType, email != null ? 0.8f : 0.6f);
            client.phoneNumber = new PhoneNumber(phone != null ? phone : "-", clientType, phone != null ? 0.8f : 0.6f);
