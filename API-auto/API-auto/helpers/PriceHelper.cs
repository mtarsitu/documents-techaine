...
namespace API_auto.helpers {
    public static class PriceHelper {
        ...
        static string[] cifre_lit = new string[] {
            "o",
            "doua",
            "trei",
            "patru",
        ...
        static string[] cifre_lit2 = new string[] {
            "zece",
            "unsprezece",
            "doisprezece",
            "treisprezece",
        ...
        public static string ConversieNumarIntreg(int numar) {
            ...
            while (numar_de_cifre != 0) {
                ...
                if (numar_de_la_pozitie > 0 || (SpecialAvemMilioane && numar_de_cifre == 7) || (SpecialAvemMii && numar_de_cifre == 4)) { // cifrele cu zero nu ne intereseaza
                    ...
                    case 2: // daca este 1 prima cifra: sprezece, altfel zeci
                        ...
                        if (numar_de_cifre == 8 && numar_de_la_pozitie > 0) SpecialAvemMilioane = false; // nu avem milioane
                        if (numar_de_cifre == 5 && numar_de_la_pozitie > 0) SpecialAvemMii = false; // nu avem mii

                        EsteFeminin = true;
                        if (numar_de_la_pozitie == 1) { // iau doua cifre acum
                            ...
                            if (numar_de_la_pozitie > 1) bool_EstePlural = true;
                    ...
                    case 4: // si "numar" de mii
                        ...
                        EsteFeminin = false;
                        if (bool_EstePlural) EsteFeminin = true;
                        else if (numar_de_cifre == 7) EsteFeminin = false;
                        else if (numar_de_cifre == 4) EsteFeminin = true;
                        bool EraGol = construit == "";

                        if (!EraGol) construit += "si ";
                ...
                if ((numar_de_cifre - 1) > 0) ridicat = RidicareLaPutere(10, numar_de_cifre - 1);
