            ...
            <Grid container spacing={3}>
              ...
              <Grid item xs={12} md={6}>
                <DefaultInfoCard
                  icon="price_change"
                  title="Achiti"
                  description="Achiti taxa de numai 3.90 euro si in cateva secunde contractul este generat automat. Urmand sa alegi ce sa faci in continuare: editezi, email, printare sau descarcare?"
                />
              </Grid>
            </Grid>
